    ...
    public static void main(String[] args) throws Exception{
        ...
        while((line = br.readLine()) != null){
            ...
            if(tipoOperacion.equals("2")){
                System.out.println("The middleware with port{" + PORTS[counter] + "} is already occupied by another substraction cell");
                counter += 1;
            }
        }
        br.close();
